  ...
  return (
    <div className={`relative inline-block ${className}`}>
      <style jsx>{`
        ...
        .urgent-badge-glow {
          ${animated ? "animation: urgentPulse 2.5s ease-in-out infinite;" : ""}
        }
      `}</style>
      ...
      <button
        ...
        className={`urgent-badge-glow font-black uppercase tracking-wider rounded-md bg-gradient-to-r from-red-600 via-rose-600 to-red-600 text-white shadow-md border border-red-500/40 flex items-center gap-1 cursor-pointer select-none ${paddingClass}`}
      >
        <span>🚨 ACİL</span>
      </button>
