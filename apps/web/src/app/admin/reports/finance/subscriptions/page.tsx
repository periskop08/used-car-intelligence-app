...
export default function FinanceSubscriptionsPage() {
  ...
  useEffect(() => {
    fetchReportApi('/admin/reports/finance/subscriptions')
      .then((res) => {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 py-8 space-y-8">
      <ReportHeader title="Abonelik Analitiği & Yaşam Döngüsü" subtitle="Aktif, iptal edilen ve süresi dolan abonelik hareketleri." />
