...
export default function ListingQualityPage() {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 py-8 space-y-8">
      <ReportHeader title="İlan Kalite Denetimi & Şüpheli İlanlar" subtitle="Eksik fotoğraflı, yetersiz açıklamalı ve piyasa değerinin altında şüpheli ilan ikazları." />
