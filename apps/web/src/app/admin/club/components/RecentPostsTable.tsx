...
export default function RecentPostsTable({ posts }: { posts: PostItem[] }) {
  ...
  return (
    <div className="rounded-2xl border border-white/10 bg-slate-900/60 overflow-hidden">
      ...
      <div className="divide-y divide-white/5">
        {posts.map((post) => (
          <div key={post.id} className="p-4 hover:bg-white/[0.02] transition flex items-center justify-between gap-4">
