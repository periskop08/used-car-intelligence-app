...
def process_logo():
    ...
    # 5. Draw the new subtitle: "YENİ NESİL ARAÇ PLATFORMU" in white/light-grey
    ...
    try:
        font = ImageFont.truetype(font_path, 28) # Slightly smaller font size to fit the longer text perfectly
    except IOError:
        font = ImageFont.load_default()
        
    # Format with spaces to match the wide letter spacing in the logo
    subtitle_text = "Y E N İ   N E S İ L   A R A Ç   P L A T F O R M U"
    ...
    # Use light slate color for premium look
    ...
    # Resize slightly so it fits beautifully in the header
    target_h = 160
