...
export const CHARACTER_RESEARCH_QUESTIONS = [
  ...
  },
  {
    ...
    questionTitle: 'Motor–şanzıman uyumu, teknik kimlik ve kullanım performansı',
    researchQuestion: `Araştırılan araçtaki motor ve şanzıman kombinasyonunun doğrulanmış fabrika teknik kimliğini (motor gücü HP / PS / kW, tork Nm, motor hacmi cc, motor kodu, şanzıman tipi/kodu, çekiş sistemi; hibrit araçlarda toplam hibrit sistem gücü, içten yanmalı motor gücü/torku ve elektrik motoru gücü/torku ayrı ayrı belirtilerek - hibrit torku asla toplanmaz) ve bu kombinasyonun aracın ağırlığı ile kasayla olan uyumunu, çekiş/hızlanma karakterini araştırıp doğrula. Her sayısal teknik veri doğrudan bulunan web kaynaklarına dayanmalıdır; kaynaklarda bulunmayan değeri üretme.`,
    researchNote: `Teknik kimlik ve performans verilerini (güç HP/PS/kW, tork Nm, motor hacmi cc vb.) web kaynaklarındaki orijinal birim ve sayısal değerleriyle aktar. Hibrit araçlarda toplam sistem gücü ile içten yanmalı motor gücünü net olarak ayırt et; hibrit torkunu asla toplama veya hesaplama. Destekleyici kaynak yoksa sayısal değer üretme, niteliksel değerlendirme yap.`,
    forbidden: ['Teknik kaynak olmadan sayısal veri üretimi', 'Hibrit torkunu toplamak veya hesaplamak', 'Motor aile genellemesi (bu motorlu tüm araçlar...)'],
    outputField: 'engineTransmissionFit',
    tavilyQueryTemplate: '{{year}} {{brand}} {{model}} {{engineCode}} {{trim}} specs technical specifications engine power horsepower torque transmission',
    turkishQueryTemplate: '{{year}} {{brand}} {{model}} {{engineCode}} {{trim}} teknik ozellikleri motor gucu beygir tork kw sanziman',
  },
  {
