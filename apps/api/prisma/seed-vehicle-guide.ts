  ...
  for (const cardData of cardsData) {
    ...
    const card = await prisma.vehicleGuideCard.create({
      data: {
        ...
        imageObjectPosition: (cardData as any).imageObjectPosition || "center center",
        imageFitMode: (cardData as any).imageFitMode || "cover",
        licenseLabelPosition: (cardData as any).licenseLabelPosition || "bottom-right",
