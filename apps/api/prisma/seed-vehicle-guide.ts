...
const rawCards: CompactCard[] = [
  ...
  // 3. Toyota Corolla E210
  {
    ...
    yearStart: 2019,
    yearEnd: 2026,
    heroImageUrl: images.corolla_e210,
  ...
  // 8. Toyota Corolla E170
  {
    ...
    yearStart: 2013,
    yearEnd: 2018,
    heroImageUrl: images.corolla_e170,
...
const brandModels = [
  { brand: "Audi", model: "A4", gen: "A4 B9", body: BodyType.SEDAN, years: "2015 - 2023", img: images.audi_a4, seg: "D", trunk: "480 L", engine: "2.0 TDI S-Tronic" },
  { brand: "Audi", model: "A6", gen: "A6 C8", body: BodyType.SEDAN, years: "2018 - 2026", img: images.audi_a6, seg: "E", trunk: "530 L", engine: "2.0 TDI Quattro" },
  { brand: "Peugeot", model: "208", gen: "208 II", body: BodyType.HATCHBACK, years: "2019 - 2026", img: images.peugeot_208, seg: "B", trunk: "311 L", engine: "1.2 PureTech EAT8" },
  { brand: "Peugeot", model: "3008", gen: "3008 II", body: BodyType.SUV, years: "2016 - 2023", img: images.peugeot_3008, seg: "C", trunk: "520 L", engine: "1.5 BlueHDi EAT8" },
  { brand: "Peugeot", model: "2008", gen: "2008 II", body: BodyType.SUV, years: "2019 - 2026", img: images.peugeot_2008, seg: "B", trunk: "434 L", engine: "1.2 PureTech EAT8" },
  { brand: "Ford", model: "Focus", gen: "Focus Mk4", body: BodyType.HATCHBACK, years: "2018 - 2026", img: images.ford_focus, seg: "C", trunk: "375 L", engine: "1.5 EcoBlue" },
  { brand: "Ford", model: "Kuga", gen: "Kuga Mk3", body: BodyType.SUV, years: "2020 - 2026", img: images.ford_kuga, seg: "C", trunk: "512 L", engine: "1.5 EcoBlue 8AT" },
  { brand: "Ford", model: "Fiesta", gen: "Fiesta Mk8", body: BodyType.HATCHBACK, years: "2017 - 2023", img: images.ford_fiesta, seg: "B", trunk: "292 L", engine: "1.0 EcoBoost" },
  { brand: "TOGG", model: "T10X", gen: "T10X", body: BodyType.SUV, years: "2023 - 2026", img: images.togg_t10x, seg: "C", trunk: "441 L", engine: "RWD Electric" },
  { brand: "Hyundai", model: "i20", gen: "i20 BC3", body: BodyType.HATCHBACK, years: "2020 - 2026", img: images.hyundai_i20, seg: "B", trunk: "352 L", engine: "1.4 MPI 6AT" },
  { brand: "Hyundai", model: "Tucson", gen: "Tucson NX4", body: BodyType.SUV, years: "2021 - 2026", img: images.hyundai_tucson, seg: "C", trunk: "577 L", engine: "1.6 T-GDI DCT" },
  { brand: "Hyundai", model: "Elantra", gen: "Elantra CN7", body: BodyType.SEDAN, years: "2021 - 2026", img: images.hyundai_elantra, seg: "C", trunk: "474 L", engine: "1.6 MPI Intelligent CVT" },
  { brand: "Nissan", model: "Qashqai", gen: "Qashqai J12", body: BodyType.SUV, years: "2021 - 2026", img: images.nissan_qashqai, seg: "C", trunk: "504 L", engine: "1.3 DIG-T Mild Hybrid" },
  { brand: "Nissan", model: "Micra", gen: "Micra K14", body: BodyType.HATCHBACK, years: "2017 - 2023", img: images.nissan_micra, seg: "B", trunk: "300 L", engine: "1.0 IG-T CVT" },
  
  // 51 new unique models to complete deck of 75
  { brand: "BMW", model: "3 Serisi", gen: "3 Serisi G20", body: BodyType.SEDAN, years: "2019 - 2026", img: images.generic_sedan, seg: "D", trunk: "480 L", engine: "320i 1.6T" },
  { brand: "BMW", model: "5 Serisi", gen: "5 Serisi G30", body: BodyType.SEDAN, years: "2017 - 2023", img: images.generic_sedan, seg: "E", trunk: "530 L", engine: "520d xDrive" },
  { brand: "BMW", model: "1 Serisi", gen: "1 Serisi F40", body: BodyType.HATCHBACK, years: "2019 - 2026", img: images.generic_hatchback, seg: "C", trunk: "380 L", engine: "116d Dual-Clutch" },
  { brand: "Opel", model: "Astra", gen: "Astra K", body: BodyType.HATCHBACK, years: "2015 - 2021", img: images.generic_hatchback, seg: "C", trunk: "370 L", engine: "1.6 CDTI" },
  { brand: "Opel", model: "Astra", gen: "Astra L", body: BodyType.HATCHBACK, years: "2021 - 2026", img: images.generic_hatchback, seg: "C", trunk: "422 L", engine: "1.2 Turbo EAT8" },
  { brand: "Opel", model: "Corsa", gen: "Corsa F", body: BodyType.HATCHBACK, years: "2019 - 2026", img: images.generic_hatchback, seg: "B", trunk: "309 L", engine: "1.2 PureTech" },
  { brand: "Opel", model: "Mokka", gen: "Mokka B", body: BodyType.SUV, years: "2021 - 2026", img: images.generic_suv, seg: "B", trunk: "350 L", engine: "1.2 Turbo" },
  { brand: "Mercedes-Benz", model: "C Serisi", gen: "C Serisi W205", body: BodyType.SEDAN, years: "2014 - 2021", img: images.generic_sedan, seg: "D", trunk: "480 L", engine: "C180 1.6" },
  { brand: "Mercedes-Benz", model: "C Serisi", gen: "C Serisi W206", body: BodyType.SEDAN, years: "2021 - 2026", img: images.generic_sedan, seg: "D", trunk: "455 L", engine: "C200 4Matic" },
  { brand: "Mercedes-Benz", model: "E Serisi", gen: "E Serisi W213", body: BodyType.SEDAN, years: "2016 - 2023", img: images.generic_sedan, seg: "E", trunk: "540 L", engine: "E200d" },
  { brand: "Mercedes-Benz", model: "A Serisi", gen: "A-Serisi W177", body: BodyType.HATCHBACK, years: "2018 - 2026", img: images.generic_hatchback, seg: "C", trunk: "370 L", engine: "A180d 7G-DCT" },
  { brand: "Volkswagen", model: "Golf", gen: "Golf 8", body: BodyType.HATCHBACK, years: "2020 - 2026", img: images.generic_hatchback, seg: "C", trunk: "381 L", engine: "1.5 eTSI DSG" },
  { brand: "Volkswagen", model: "Polo", gen: "Polo Mk6", body: BodyType.HATCHBACK, years: "2017 - 2026", img: images.generic_hatchback, seg: "B", trunk: "351 L", engine: "1.0 TSI DSG" },
  { brand: "Volkswagen", model: "Tiguan", gen: "Tiguan Mk2", body: BodyType.SUV, years: "2016 - 2024", img: images.generic_suv, seg: "C", trunk: "615 L", engine: "1.5 TSI DSG" },
  { brand: "Renault", model: "Captur", gen: "Captur II", body: BodyType.SUV, years: "2020 - 2026", img: images.generic_suv, seg: "B", trunk: "422 L", engine: "1.3 TCe EDC" },
  { brand: "Renault", model: "Kadjar", gen: "Kadjar", body: BodyType.SUV, years: "2015 - 2022", img: images.generic_suv, seg: "C", trunk: "472 L", engine: "1.5 dCi EDC" },
  { brand: "Fiat", model: "Egea", gen: "Egea Hatchback", body: BodyType.HATCHBACK, years: "2016 - 2026", img: images.generic_hatchback, seg: "C", trunk: "440 L", engine: "1.6 Multijet" },
  { brand: "Fiat", model: "Egea", gen: "Egea Cross", body: BodyType.SUV, years: "2021 - 2026", img: images.generic_suv, seg: "C", trunk: "440 L", engine: "1.4 Fire Eco" },
  { brand: "Fiat", model: "Fiorino", gen: "Fiorino Combi", body: BodyType.MINIVAN, years: "2007 - 2026", img: images.generic_hatchback, seg: "B", trunk: "356 L", engine: "1.3 Multijet" },
  { brand: "Honda", model: "Civic", gen: "Civic FE", body: BodyType.SEDAN, years: "2021 - 2026", img: images.generic_sedan, seg: "C", trunk: "512 L", engine: "1.5 VTEC Eco CVT" },
  { brand: "Honda", model: "CR-V", gen: "CR-V V", body: BodyType.SUV, years: "2018 - 2023", img: images.generic_suv, seg: "D", trunk: "561 L", engine: "1.5 VTEC CVT" },
  { brand: "Toyota", model: "C-HR", gen: "C-HR II", body: BodyType.SUV, years: "2023 - 2026", img: images.generic_suv, seg: "C", trunk: "388 L", engine: "1.8 Hybrid e-CVT" },
  { brand: "Toyota", model: "Yaris", gen: "Yaris XP210", body: BodyType.HATCHBACK, years: "2020 - 2026", img: images.generic_hatchback, seg: "B", trunk: "286 L", engine: "1.5 Hybrid e-CVT" },
  { brand: "Audi", model: "A3", gen: "A3 8Y", body: BodyType.HATCHBACK, years: "2020 - 2026", img: images.generic_hatchback, seg: "C", trunk: "380 L", engine: "35 TFSI Mild Hybrid" },
  { brand: "Audi", model: "Q3", gen: "Q3 F3", body: BodyType.SUV, years: "2018 - 2026", img: images.generic_suv, seg: "C", trunk: "530 L", engine: "35 TFSI S-Tronic" },
  { brand: "Peugeot", model: "308", gen: "308 III", body: BodyType.HATCHBACK, years: "2021 - 2026", img: images.generic_hatchback, seg: "C", trunk: "412 L", engine: "1.2 PureTech EAT8" },
  { brand: "Peugeot", model: "508", gen: "508 II", body: BodyType.SEDAN, years: "2018 - 2026", img: images.generic_sedan, seg: "D", trunk: "487 L", engine: "1.5 BlueHDi EAT8" },
  { brand: "Nissan", model: "Juke", gen: "Juke F16", body: BodyType.SUV, years: "2019 - 2026", img: images.generic_suv, seg: "B", trunk: "422 L", engine: "1.0 DIG-T DCT" },
  { brand: "Skoda", model: "Octavia", gen: "Octavia Mk3", body: BodyType.SEDAN, years: "2013 - 2020", img: images.generic_sedan, seg: "C", trunk: "590 L", engine: "1.6 TDI DSG" },
  { brand: "Skoda", model: "Octavia", gen: "Octavia Mk4", body: BodyType.SEDAN, years: "2020 - 2026", img: images.generic_sedan, seg: "C", trunk: "600 L", engine: "1.5 eTSI DSG" },
  { brand: "Skoda", model: "Superb", gen: "Superb Mk3", body: BodyType.SEDAN, years: "2015 - 2024", img: images.generic_sedan, seg: "D", trunk: "625 L", engine: "1.6 TDI DSG" },
  { brand: "Skoda", model: "Kamiq", gen: "Kamiq", body: BodyType.SUV, years: "2019 - 2026", img: images.generic_suv, seg: "B", trunk: "400 L", engine: "1.5 TSI DSG" },
  { brand: "Skoda", model: "Karoq", gen: "Karoq", body: BodyType.SUV, years: "2017 - 2026", img: images.generic_suv, seg: "C", trunk: "521 L", engine: "1.5 TSI DSG" },
  { brand: "Dacia", model: "Duster", gen: "Duster II", body: BodyType.SUV, years: "2018 - 2024", img: images.generic_suv, seg: "C", trunk: "478 L", engine: "1.3 TCe EDC" },
  { brand: "Dacia", model: "Sandero", gen: "Sandero Stepway III", body: BodyType.HATCHBACK, years: "2020 - 2026", img: images.generic_hatchback, seg: "B", trunk: "328 L", engine: "1.0 TCe CVT" },
  { brand: "Seat", model: "Leon", gen: "Leon Mk3", body: BodyType.HATCHBACK, years: "2012 - 2020", img: images.generic_hatchback, seg: "C", trunk: "380 L", engine: "1.6 CDTI DSG" },
  { brand: "Seat", model: "Leon", gen: "Leon Mk4", body: BodyType.HATCHBACK, years: "2020 - 2026", img: images.generic_hatchback, seg: "C", trunk: "380 L", engine: "1.5 eTSI DSG" },
  { brand: "Seat", model: "Ibiza", gen: "Ibiza Mk5", body: BodyType.HATCHBACK, years: "2017 - 2026", img: images.generic_hatchback, seg: "B", trunk: "355 L", engine: "1.0 TSI DSG" },
  { brand: "Seat", model: "Ateca", gen: "Ateca", body: BodyType.SUV, years: "2016 - 2026", img: images.generic_suv, seg: "C", trunk: "510 L", engine: "1.5 EcoTSI DSG" },
  { brand: "Citroen", model: "C3", gen: "C3 III", body: BodyType.HATCHBACK, years: "2016 - 2024", img: images.generic_hatchback, seg: "B", trunk: "300 L", engine: "1.2 PureTech EAT6" },
  { brand: "Citroen", model: "C4", gen: "C4 III", body: BodyType.SUV, years: "2020 - 2026", img: images.generic_suv, seg: "C", trunk: "380 L", engine: "1.2 PureTech EAT8" },
  { brand: "Citroen", model: "C5 Aircross", gen: "C5 Aircross", body: BodyType.SUV, years: "2018 - 2026", img: images.generic_suv, seg: "C", trunk: "580 L", engine: "1.5 BlueHDi EAT8" },
  { brand: "Kia", model: "Sportage", gen: "Sportage QL", body: BodyType.SUV, years: "2015 - 2021", img: images.generic_suv, seg: "C", trunk: "503 L", engine: "1.6 CRDi DCT" }
];
