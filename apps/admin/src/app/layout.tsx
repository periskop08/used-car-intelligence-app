        ...
        <div className="min-h-screen flex flex-col">
          ...
          <header className="border-b border-slate-800 bg-slate-950/50 backdrop-blur px-6 py-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <span className="text-xl font-black tracking-wider text-orange-500">TORQUESCOUT</span>
          ...
          <main className="flex-1 flex">
            ...
            <aside className="w-64 border-r border-slate-800 bg-slate-950/30 p-6 flex flex-col gap-2">
              ...
              <a href="/admin/listings" className="flex items-center gap-3 px-3 py-2 rounded-lg text-slate-400 hover:bg-slate-800/50 hover:text-slate-200 transition">
                🚗 İlan Moderasyonu
              </a>
